...
program
  ...
  .option('-m, --model <model>', 'OpenRouter model ID', 'bytedance/seedance-2.0')
  ...
  .option('--max-duration <seconds>', 'Cap for auto duration (ignored when duration is a fixed number)')
